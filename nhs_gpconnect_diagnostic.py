...
def get_public_ip():
    ...
    try:
        ...
        ip = urllib.request.urlopen('https://api.ipify.org', timeout=10).read().decode('utf-8')
...
def main():
    ...
    print(f"🎯 Interaction ID: urn:nhs:names:services:gpconnect:fhir:operation:gpc.getstructuredrecord-1")
    print()
