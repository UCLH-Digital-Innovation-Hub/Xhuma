...
| **GitHub Environments** | Unauthorised deployment from the rehearsal branch. | Deployment paused and required explicit authorisation to proceed to the `play` environment. | **Implemented Control** / **Observed** |
